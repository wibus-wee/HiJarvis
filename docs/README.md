...
- [Agent Runtime](./agent-runtime.md): workspace startup flow, source-first package boundaries, thread/lane-bound turn/run/item execution, model resolution, hooks, and event handling.
